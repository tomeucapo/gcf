...
class PHPExcel_Writer_PDF_mPDF extends PHPExcel_Writer_PDF_Core implements PHPExcel_Writer_IWriter {
	...
	public function save($pFilename = null) {
		...
		$pdf->addPage(strtoupper($paperSize)."-".$orientation);
        $pdf->SetFooter("Pàgines: {PAGENO}/{nb}  Data d'impressió: ".date("d/m/Y H:i:s"));

        //$pdf->SetFooter($this->_phpExcel->getActiveSheet()->getHeaderFooter()->getEvenFooter());
