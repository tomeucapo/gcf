...
class terminal 
{
    ...
    /**
     * M�tode que inicialitza la connexi� al terminal
     */
    ...
    /**
     * M�tode per llegir la data/hora del terminal
     ...
     */
     ...
     /**
      * M�tode per ajustar la data/hora del terminal
      * @param $data
      * @param $hora
      * @return bool
      */
      public function setTime($data, $hora)
      {
               if($this->connected) 
                  return ($this->clientTime->sendCommand("TARGET", "settime", array("time" => $hora, "date" => $data))>=0);

               return false;
      }

    /**
     * M�tode per determinar l'estat del terminal
     * @return array
     */
    ...
    /**
     * M�tode per determinar la configuraci� del terminal
     ...
     */
      ...
      // M�tode per configurar el terminal
      ...
      // M�tode que ens llegeix la informaci� general del terminal
      ...
      // M�tode que carrega una llista de incid�ncies a la terminal
      ...
      public function sendIncidences($l_incidencies)
      {
               ...
               if($this->connected)
               {
                  $status = true;$max = count($l_incidencies); $i=0;
                  $darrera = "false";
      ...
      // M�tode que borra totes les incid�ncies de la terminal
      ...
      // M�tode per descarregar els marcatges del terminal
      ...
      // M�tode per borrar els marcatges del terminal
      ...
      // M�tode que permet activar/desactivar l'enmagatzemament dels marcatges dins el terminal
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////
      // Metodes per a la gesti� de les empremptes
    ...
    /**
     * M�tode que carrega una llista d'usuaris a la terminal
     ...
     */
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////
      // Metodes per a la gesti� de les comptes d'usuari 
      ...
      // M�tode que borra una llista d'usuaris a la terminal
      ...
      // M�tode per borrar tots els usuaris d'un terminal
      ...
      // M�tode per a configurar els permisos d'un usuari creat amb createUser
      ...
      // M�tode que permet activar/desactivar la visualitzacio del nom del usuari per pantalla
     ...
     * @return bool
     */
      public function setHollidaysConsulting($active)
      {
               if(!$this->connected)
                  return false;
